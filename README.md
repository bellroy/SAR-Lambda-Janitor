...
2. In this repo, run (with aws-sso-login Shared-MSK-and-VPC.Infra):

```
sam package --output-template-file packaged.yaml --s3-bucket sar-lambda-janitor-ls6qh6jc5vra --region us-east-1
```
...
4. Repeat the above 2 steps but for the aws-east-2 region 5. Check that the Application at your new version is available in the Serverless Application Repository in both regions 
